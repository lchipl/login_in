...
import AddItem from '../add-new-item/addI-item';
import './app.css';
...
export class App extends Component {
  ...
  state={
   ...
   todoData: [
    { label: 'улучшить вёрстку', important: false, done:false, id: 1 },
    { label: 'Залить проекты на github', important: false, done:false, id: 2 },
    { label: 'React Redux', important: false, done:false, id: 3 },
  ],
  tend:"",
  filter:"all"
}
  ...
  return (
    <div className="todo-app">
      ...
      <TodoList todos={Visible}
       ...
       />
       <AddItem createNewElement={this.createNewElement} />
    </div>
  );
}
}
